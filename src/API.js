...
const MESSAGES = `/chat/all-messages`;
var i = 10;
const apiSettings = {
    findChat: async (anotherUserId, jwtToken) => {
        ...
        // })).json();
        const result = {
            // id:"53d327cc-66b1-4ab5-ba26-8873d671b34a",
            // users: [
            //     "07f2fbe7-47ae-4d8e-94bf-05d7763f20c0",
            //     "027233f8-8a69-4baa-af74-931ddf611d1a"
            // ],
            // createdAt:"2022-04-18T09:16:54.851151"
